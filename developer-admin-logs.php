    ...
    <main class="app-content">
      <div class="app-title">
        <div id="divProfile">
          ...
          <h1><i class="fa fa-th-list"></i> Coordinator Logs</h1>
          <p>List of coordinator logs</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="developer-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item">Logs</li>
          <li class="breadcrumb-item active"><a href="#">Coordinator Logs</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered" id="sampleTables">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT * FROM admin_logs_tbl";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr style="font-size: 15px;">
                            ...
                            <td><strong>Admin Name:</strong> ' . $a_lname . ', ' . $a_fname . '</td>
                            <td><strong>Department:</strong> ' . $department . '</td>
                            <td><strong>Time Log:</strong> ' . $time_log . '</td>
                            <td><strong>Activty:</strong> ' . $activity . '</td>
                            <td><strong>Student ID #:</strong> ' . $student_id_number . '</td>
                            <td><strong>Student Name:</strong> ' . $student_fname . ', '. $student_lname .'</td>
                            <td><strong>Student Department:</strong> ' . $s_department .'</td>
                          </tr>';
                  }
                  ?>
                </tbody>
