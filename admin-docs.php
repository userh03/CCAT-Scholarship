  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
          ...
          </style>          <h1><i class="fa fa-file-text"></i> Upload Page</h1>
          <p>Upload Data</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
          <li class="breadcrumb-item"><a href="admin-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item"><a href="#">Upload Page</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <table class="table table-hover table-bordered" id="sampleTables">
                <thead>
                  <tr style="font-size: 16px; text-align: center;">
                    ...
                    <th scope="col">Time (Date | hh | mm | ss)</th>
                  </tr>
                </thead>
                <tbody>
                  <!-- PHP Database Display -->
                  <?php
                  $sql = "SELECT * FROM uploaded_excel_files";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr style="font-size: 15px;">
                            ...
                            <td><strong>File Name:</strong> ' . $file_name . '</td>
                            <td><strong>Time:</strong> ' . $upload_date . '</td>
                            </tr>';
                  }
                  ?>
                </tbody>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            ...
            <small><i><i class="fa fa-question-circle" aria-hidden="true"></i><span style="font-weight: 700;"> Excel Column Format:</span> Student ID Number,	Firstname,	Lastname,	Subject Code,	Subject Name,	Semester,	Year, Grade, Units</i></small>
              <form method="POST" enctype="multipart/form-data" action="php/import.php">
                  <input class="btn btn-secondary" style="color: black;" required type="file" name="excel_file" accept=".xlsx, .xls">
                  <br><br>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <h2>Import Student Data For their Registration</h2>
            <small><i><i class="fa fa-question-circle" aria-hidden="true"></i><span style="font-weight: 700;"> Excel Column Format:</span> Student ID Number,	Firstname,	Lastname,	Email,	Department,	Section,	Mobile Number</i></small>
              <form method="POST" enctype="multipart/form-data" action="php/import-stud.php">
                  <input class="btn btn-secondary" style="color: black;" required type="file" name="excel_file" accept=".xlsx, .xls">
                  <br><br>
                  <input class="btn btn-primary" type="submit" value="Import">
              </form>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <h2>Import TES Scholarship Applicants</h2>
              <form method="POST" enctype="multipart/form-data" action="php/import-tes.php">
                  <input class="btn btn-secondary" style="color: black;" required type="file" name="excel_file" accept=".xlsx, .xls">
                  <br><br>
                  <input class="btn btn-primary" type="submit" value="Import">
              </form>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
            <h2>Import TDP Scholarship Applicants</h2>
              <form method="POST" enctype="multipart/form-data" action="php/import-tdp.php">
                  <input class="btn btn-secondary" style="color: black;" required type="file" name="excel_file" accept=".xlsx, .xls">
                  <br><br>
                  <input class="btn btn-primary" type="submit" value="Import">
              </form>
    ...
    <script type="text/javascript">
      ...
      if (error === 'file_exists') {
        $.notify({
            title: "Upload Failed!",
            message: "File was previously uploaded",
            icon: 'fa fa-exclamation-circle',
            // Add the 'text-white' class for white font color
        ...
        $.notify({
            title: "Upload Failed!",
            message: "Mismatched column names.",
            icon: 'fa fa-exclamation-circle',
            // Add the 'text-white' class for white font color
            className: 'text-white'
        }, {
    ...
    <script>
      $(document).ready(function() {
          ...
          $.ajax({
              url: 'php/clearExcelFiles.php',
              type: 'GET',
              dataType: 'json',
              success: function(response) {
                  // Handle the response here, e.g., display messages to the user
              },
              error: function() {
