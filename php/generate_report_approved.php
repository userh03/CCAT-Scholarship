...
$sql = "SELECT app_id, app_student_number, app_fname, app_lname, app_mobile, app_email, app_section, app_department, app_adviser, app_status FROM approved_applicants_tbl";
...
if ($result->num_rows > 0) {
    ...
    while ($row_data = $result->fetch_assoc()) {
        ...
        $sheet->setCellValue('J' . $row, $row_data['app_status']);
        $row++;
    }

    // Set the header information for the Excel file
    header('Content-Type: application/vnd.ms-excel');
    header('Content-Disposition: attachment;filename="approved_applicant_list.xls"');
