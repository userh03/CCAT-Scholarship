...
$sql = "SELECT app_id, app_student_number, app_fname, app_lname, app_mobile, app_email, app_section, app_scholar_type, app_department, app_year, app_status
          FROM approved_applicants_tbl 
        WHERE app_scholar_type LIKE '%Talent%' OR app_scholar_type LIKE '%Service%'";
...
// File path and name
$filename = 'talent-and-service-scholarship.csv';
...
// Data for the CSV
$data = array();
$data[] = array('app_id', 'app_student_number', 'app_fname', 'app_lname', 'app_mobile', 'app_email', 'app_section', 'app_department', 'app_scholar_type', 'app_year', 'app_status');
