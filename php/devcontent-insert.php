...
if (isset($_POST['asubmit'])) {
    ...
    $sql = "INSERT INTO newsupdate_tbl (title, content) VALUES ('$title', '$content')";
    ...
    if (mysqli_query($con, $sql)) {
        ...
        if (isset($_FILES["images"])) {
            ...
            $file_name = "img" . $insertedId . "_news." . $file_extension;
            ...
            if (move_uploaded_file($_FILES["images"]["tmp_name"], $target_file)) {
                ...
                $updateSql = "UPDATE newsupdate_tbl SET images = '$file_path' WHERE id = $insertedId";
                if (mysqli_query($con, $updateSql)) {
                    // Redirect to success page
                    header('Location: ../developer-user-content.php?success=true');
                    exit;
                } else {
                    // Redirect to error page
                    header('Location: ../developer-user-content.php?success=false');
                    exit;
                }
            } else {
                // Redirect to error page
