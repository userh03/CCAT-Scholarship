...
$sql = "SELECT app_id, app_student_number, app_fname, app_lname, app_mobile, app_email, app_section, app_department, app_adviser, app_status FROM denied_applicants_tbl";
...
if ($result->num_rows > 0) {
    ...
    header('Content-Disposition: attachment;filename="denied_applicant_list.xls"');
