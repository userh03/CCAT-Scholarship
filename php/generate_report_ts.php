...
if ($result->num_rows > 0) {
    ...
    $sheet->setCellValue('I1', 'Scholar Type');
    ...
    while ($row_data = $result->fetch_assoc()) {
        ...
        $sheet->setCellValue('I' . $row, $row_data['app_scholar_type']);
    ...
    header('Content-Disposition: attachment;filename="talent-and-service-scholarship.xls"');
