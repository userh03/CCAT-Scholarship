...
if(isset($_POST['isubmit']))
{
    ...
    if(isset($_POST['profile_picture'])) {
     ...
     if($count_id > 0)
     {
         ...
         echo '<script>
                 window.location.href = "../developer-add-edit-students.php?row_filled=true";
             </script>';
         exit;
     }
     ...
     if($count_email > 0)
     {
         ...
         echo '<script>
                  window.location.href = "../developer-add-edit-students.php?row_email=true";
             </script>';
         exit;
     }
    ...
    else
    {
        ...
        {   
            ...
            header("location: ../developer-add-edit-students.php?success=true");
            exit;
        }
        else
        {
