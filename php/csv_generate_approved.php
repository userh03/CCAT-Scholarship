...
$sql = "SELECT app_id, app_student_number, app_fname, app_lname, app_mobile, app_email, app_section, app_department, app_adviser, app_scholar_type, app_status FROM approved_applicants_tbl";
