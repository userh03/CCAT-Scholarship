...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['deleteid'])) {
    ...
    $developer_id_number = mysqli_real_escape_string($con, $_POST['developer_id_number']);
    ...
    if ($result) {
        ...
        mysqli_stmt_bind_param($logStmt, "ssssssss", $sa_fname, $sa_lname, $student_id_number, $fname, $lname, $developer_id_number, $department, $s_department); // Updated line
