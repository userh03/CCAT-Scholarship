<?php
    ...
    $teacher_id_number = $row['superadmin_id_number'];
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
          ...
          </style>          <h1><i class="fa fa-th-list"></i> Pending Applicants List</h1>
          <p>List of Pending Applicants</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="admin-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item active"><a href="#">Pending Applicants List</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTables">
                  ...
                  <tbody>
                    ...
                    <?php
                      $sql = "SELECT * FROM applicant_tbl WHERE app_year = '$year' AND app_status = 'Pending' OR app_status = 'On-process'";
    ...
    <script>
      function updateStatus(app_id, status) {
        var a_id = "<?php echo $sa_id ?>";
        var a_fname = "<?php echo $sa_fname ?>";
        var a_lname = "<?php echo $sa_lname ?>";
              ...
              $.ajax({
                  ...
                  success: function (response) {
                      ...
                      if (response.status === 'Success') {
                          window.location.href='php/successd.php';
