...
<link href="https://fonts.googleapis.com/css2?family=Oswald&display=swap" rel="stylesheet">
  ...
  <body class="app sidebar-mini">
            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form method="POST" action="php/superinsertstud.php">
                    <div class="row mb-4">
                      <div class="col-md-12">
                                      ...
                                      <div class="modal fade" id="myModal'.$s_id.'" tabindex="-1" role="dialog" style="z-index: 9900;" aria-labelledby="myModalLabel">
                                        <div class="modal-dialog" role="document">
                                          <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                            <form method="POST" action="php/superupdatestud.php?updateid='.$s_id.'">
                                                  <div class="row mb-4">
                                                    <div class="col-md-12">
                                                  ...
                                                  <div class="row mb-4">
                                                    ...
                                                    <div class="col-md-12 mb-4 w-100">
                                                      ...
                                                      <input type="number" style="text-align: center;" class="form-control" name="mobile" value="' . htmlspecialchars($mobile) . '">
                                                    </div>
                                                    <div class="clearfix"></div>
                                                    <div class="col-md-12">
    ...
    function demoSwal(s_id, fname, lname, student_id_number, s_department) {
        var sa_fname = "<?php echo $sa_fname ?>";  
        var sa_lname = "<?php echo $sa_lname ?>";  
        ...
        swal({
          ...
          if (isConfirm) {
                ...
                $.ajax({
                    url: 'php/superdeletestud-temp.php',
                    type: 'POST',
                    data: {
                        deleteid: s_id,
                        sa_fname: sa_fname,
