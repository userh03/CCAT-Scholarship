  ...
  <body class="app sidebar-mini">
                    ...
                    $sql = "SELECT *
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                        ...
                        echo '<tr style="font-size: 15px;">
                                <td scope = "row"><strong>Teacher ID #: </strong>'.$superadmin_id_number.'</td>
                                    <td><strong>Teacher Name: </strong>'.$sa_lname.', '.$sa_fname.'</td>
                                    <td><strong>Department: </strong>'.$sa_building.'</td>
                                    <td><strong>Mobile: </strong>'.$mobile.'</td>
                                    <td><strong>Email: </strong>'.$email.'</td>
                                    <td>
                                      <div id="operation-field" style="word-spacing: 5px;">
                                      <button type="button" class="btn btn-primary" style="margin-bottom: 5px;" onclick="restore('.$sa_id.')">
                                        Restore
                                      </button>
                                        <button style="margin-bottom: 5px;" class="btn btn-danger" onclick="demoSwal('.$sa_id.');" name="delete">Delete</button>
                                      </div>
                                    </td>
                              </tr>';
                      }
            ...
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        window.location.href = 'php/devdelete.php?deleteid=' + sa_id;
                    });
                }
            });
        };
            ...
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        window.location.href = 'php/devdelete-temp-restore.php?restoreid=' + sa_id;
                    });
                }
            });
        };
    ...
    <script>
        ...
        function deleteAllData() {
            ...
            var phpScriptUrl = 'php/devdelete-temp-all.php';

            // Use AJAX to send a request to the PHP script
            $.ajax({
            type: 'POST',
            url: 'php/devdelete-temp-all.php',
    ...
    <script>
        ...
        function restoreAllData() {
            // Assuming you're using AJAX to call the PHP script
            // You can replace this with your actual PHP script URL
            var phpScriptUrl = 'php/devrestore-temp-all.php';

            // Use AJAX to send a request to the PHP script
            $.ajax({
            type: 'POST',
            url: 'php/devrestore-temp-all.php',
