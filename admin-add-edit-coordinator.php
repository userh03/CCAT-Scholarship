...
<html lang="en">
  <head>
    <title>Add/Edit Coordinator</title>
...
<link href="https://fonts.googleapis.com/css2?family=Oswald&display=swap" rel="stylesheet">
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        input[type="number"] {
          ...
          <h1><i class="fa fa-th-list"></i> Add/Edit Coordinator</h1>
          <p>Coordinator List</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="admin-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item">Coordinator Settings</li>
          <li class="breadcrumb-item active"><a href="#">Add/Edit Coordinator</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                      <h2 class="modal-title" id="myModalLabel">Add New Coordinator</h2>
                    </div>
                  <div class="modal-body">
                  <form method="POST" action="php/superinsert.php">
                    <div class="row mb-4">
                      <div class="col-md-12">
                        <label>Teacher ID #</label>
                        <input class="form-control" type="number" id="" name="teacher_id_number" placeholder="Enter teacher ID #" required>
                      </div>
                      <div class="col-md-6">
                        <br><label>First Name</label>
                        <input class="form-control" type="text" id="" name="a_fname" placeholder="Enter first name" required>
                      </div>
                      <div class="col-md-6">
                        <br><label>Last Name</label>
                        <input class="form-control" type="text" id="" name="a_lname" placeholder="Enter last name" required><br>
                      </div>
                      <div class="col-md-6 mb-4">
                        <label>Department</label>
                        <select class="form-control" type="text" id="" name="department" placeholder="Enter department" required>
                    ...
                    <div class="modal-footer">
                      ...
                      <button class="btn btn-primary" id="submitButton" disabled type="submit" name="asubmit">Save</button>
                    </div>
                  </form>  
                  </div>
               </div>
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered" id="sampleTables">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT * FROM admin_tbl  WHERE IFNULL(username, '') <> '' AND IFNULL(password, '') <> '' AND isValid = 1";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr style="font-size: 15px;">
                            <td><strong>Teacher ID #:</strong> ' . $teacher_id_number . '</td>
                            <td><strong>Coordinator Name:</strong> ' . $a_lname . ', ' . $a_fname . '</td>
                            ...
                            <td>
                              <div id="operation-field" style="word-spacing: 5px;">
                                <i class="btn btn-primary fa fa-pencil-square-o" data-toggle="modal" data-target="#myModal' . $a_id . '"></i>
                                <div class="modal fade" id="myModal' . $a_id . '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      <div class="modal-header">
                                      ...
                                      <div class="modal-body">
                                        <form method="POST" action="php/superupdate.php?updateid=' . $a_id . '">
                                          <div class="row mb-4">
                                            <div class="col-md-12">
                                              <br><label for="a_fname">Teacher ID Number:</label>
                                              <input style="text-align: center;" type="text" disabled="" class="form-control" value="' . htmlspecialchars($teacher_id_number) . '">
                                            </div>
                                            <div class="col-md-6">
                                              <br><label for="a_fname">First Name:</label>
                                              <input type="text" class="form-control" style="text-align: center;" name="a_fname" value="' . htmlspecialchars($a_fname) . '">
                                            </div>
                                            <div class="col-md-6">
                                              <br><label for="a_lname">Last Name:</label>
                                              <input type="text" class="form-control" style="text-align: center;" name="a_lname" value="' . htmlspecialchars($a_lname) . '">
                                            </div>
                                            <div class="col-md-12">
                                            ...
                                            <div class="col-md-6">
                                              ...
                                              <div class="input-group">
                                                <input class="form-control" type="password" style="text-align: center;" onkeyup="checkPassword2(' . $a_id . ')" name="password" id="password2_' . $a_id . '" placeholder="Password">
                                                <div class="input-group-append">
                                                <span class="input-group-text password-toggle-icon" onclick="togglePassword2(\'password2_' . $a_id . '\', \'togglePasswordIcon2_' . $a_id . '\')">
                                                  <i class="fa fa-eye-slash" id="togglePasswordIcon2_' . $a_id . '"></i>
                                                </span>
                                                </div>
                                              </div>
                                              <div id="passwordCheck2_' . $a_id . '" class="mt-2"></div>
                                            </div>
                                            <div class="col-md-6"><br>
                                            <label>Confirm Password</label>
                                              <div class="input-group">
                                                <input type="password" name="confirmPassword" style="text-align: center;" class="form-control" id="confirmPassword2_' . $a_id . '" onkeyup="validatePassword2(' . $a_id . ')" placeholder="Confirm your new password">
                                                <div class="input-group-append">
                                                  <span class="input-group-text password-toggle-icon" onclick="togglePasswordVisibility2(\'confirmPassword2_' . $a_id . '\', \'showConfirmPasswordBtn2_' . $a_id . '\')">
                                                    <i class="fa fa-eye-slash" id="showConfirmPasswordBtn2_' . $a_id . '"></i>
                                                  </span>
                                                </div>
                                              </div>
                                              <div id="passwordError2_' . $a_id . '" class="mt-2"></div>
                                            </div>
                                            <div class="col-md-6">
                                              <br><label for="department">Department:</label>
                                              <select class="form-control" style="text-align: center;" type="text" id="" name="department">
                                                <optgroup label="Select Department">
                                                  <option value="Department օf Computer Studies"' . ($department == "Department օf Computer Studies" ? ' selected' : '') . '>Department of Computer Studies</option>
                                                  <option value="Department օf Engineering"' . ($department == "Department օf Engineering" ? ' selected' : '') . '>Department of Engineering</option>
                                                  <option value="Department օf Industrial Technology"' . ($department == "Department օf Industrial Technology" ? ' selected' : '') . '>Department of Industrial Technology</option>
                                                  <option value="Department օf Management Studies"' . ($department == "Department օf Management Studies" ? ' selected' : '') . '>Department of Management Studies</option>
                                                  <option value="Department օf Teacher Education"' . ($department == "Department օf Teacher Education" ? ' selected' : '') . '>Department of Teacher Education</option>
                                                </optgroup>
                                              </select>                                              
                                            </div>
                                            <div class="col-md-6">
                                          ...
                                          <div class="modal-footer">
                                            <button class="btn btn-default" data-dismiss="modal">Close</button>
                                            <button class="btn btn-primary" id="submitButton2_' . $a_id . '" type="submit" name="submit">Save changes</button>
                                          </div>
                                        </form>
                                      </div>
                                    </div>
                                ...
                                <i class="btn btn-danger fa fa-trash-o" onclick="demoSwal('.$a_id.', \''.$a_fname.'\', \''.$a_lname.'\', \''.$teacher_id_number.'\');"></i>
                                </div>
                            </td>
                          </tr>';
                  }
    ...
    function demoSwal(a_id, a_fname, a_lname, teacher_id_number) {
      var admin_fname = "<?php echo $sa_fname ?>";
      var admin_lname = "<?php echo $sa_lname ?>";
    ...
    <script>
        ...
        if (success === 'true') {
            ...
            swal({
                title: "Success!",
                text: "Coordinator may now register.",
                type: "success",
                showCancelButton: false,
                confirmButtonText: "OK",
                closeOnConfirm: true,
          ...
          if (row_filled === 'true') {
              ...
              swal({
                  ...
                  text: "Double check the teacher id number.",
                  type: "error",
                  showCancelButton: false,
                  confirmButtonText: "OK",
                  closeOnConfirm: true,
...
<script>
  function validatePassword2(a_id) {
    const submitButton2 = document.getElementById('submitButton2_'+a_id);
    const password2 = document.getElementById("password2_"+a_id).value;
    const confirmPassword2 = document.getElementById("confirmPassword2_"+a_id).value;
    const passwordError2 = document.getElementById("passwordError2_"+a_id);

    // Call checkPassword for detailed validation
    const isPasswordValid2 = checkPassword2(a_id);
  ...
  function checkPassword2(a_id) {
    const passwordInput = document.getElementById('password2_'+a_id);
    const passwordCheck = document.getElementById('passwordCheck2_'+a_id);
    const submitButton2 = document.getElementById('submitButton2_'+a_id);
