            ...
            @media screen and (max-width: 767px) {
                #divProfile {
                  display: none;
                    ...
                    <h1><i class="fa fa-th-list"></i> Pending Applicants List</h1>
          ...
          <div class="tile">
            ...
            <style>
              ...
              <table class="table table-hover table-bordered" id="sampleTables">
                ...
                <script>
                  function openFolder(studentNumber) {
                      // Construct the URL or path to the folder based on app_student_number
                       var folderUrl = 'uploaded_docs/' + studentNumber;

                      // Open the folder in a new window or tab
