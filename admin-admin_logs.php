...
?>
<?php 
  $query3 = "SELECT * FROM devs_tbl";
  $result3 = mysqli_query($con, $query3);
  $row3 = mysqli_fetch_assoc($result3);

  $d_fname = $row3['d_fname'];
  $d_lname = $row3['d_lname'];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered" id="sampleTables">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT * FROM superadmin_logs_tbl WHERE admin_fname != '$d_fname' AND admin_lname != '$d_fname'";
