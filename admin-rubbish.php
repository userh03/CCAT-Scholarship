      ...
      <ul class="app-nav">
            ...
            function handleNotificationClick(event) {
              ...
              $.ajax({
                ...
                if (response === 'Success') {                  
                  ...
                  window.location.href = 'superadmin_tables.php';
                }
              },
              });
            }
          ...
          <li class="dropdown"><a class="app-nav__item" href="#" data-toggle="dropdown" aria-label="Open Profile Menu"><i class="fa fa-user fa-lg"></i></a>
            <ul class="dropdown-menu settings-menu dropdown-menu-right">
              <li><a class="dropdown-item" href="superadmin_page-user.php"><i class="fa fa-user fa-lg"></i> Profile</a></li>
              <li><a class="dropdown-item" href="user-settings-superadmin.php"><i class="fa fa-cog fa-lg"></i> Account Settings</a></li>
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
        ...
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="superadmin-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
            ...
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        window.location.href = 'php/superdeletestud.php?deleteid=' + s_id;
                    });
                }
            });
        };
            ...
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        window.location.href = 'php/superdeletestud-temp-restore.php?restoreid=' + s_id;
                    });
                }
            });
        };
    ...
    <script>
        ...
        function deleteAllData() {
            ...
            success: function (response) {
                ...
                window.location.href = 'superadmin_rubbish.php';
                });
            },
            error: function () {
