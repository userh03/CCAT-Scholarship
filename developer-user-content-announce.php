              ...
              <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <form method="POST" action="php/devcontent-insert-announce.php" enctype="multipart/form-data">
                      <div class="row mb-4">
                        <div class="col-md-12">
                                      ...
                                      <div class="modal fade" id="myModal'.$id.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                          <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <form method="POST" action="php/devcontent-announce.php?updateid=' . $id . '" enctype="multipart/form-data">
                                                          <div class="row mb-4">
                                                              <div class="col-md-12">
    ...
    swal({
        ...
        if (isConfirm) {
            swal({
                ...
                window.location = "php/devcontentdelete-announce.php?deleteid=" + id;
            });
        }
    });
    }
