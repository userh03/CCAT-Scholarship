...
<html lang="en">
  <head>
    <title>Approved Applicant List</title>
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
          ...
          </style>          <h1><i class="fa fa-th-list"></i> Approved Applicants List</h1>
        ...
        <ul class="app-breadcrumb breadcrumb side">
          ...
          <li class="breadcrumb-item active"><a href="#">Approved Applicants List</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="table-responsive">
                <table class="table table-hover table-bordered" id="sampleTables">
                  ...
                  <tbody>
                    ...
                    <?php
                      $sql = "SELECT * FROM approved_applicants_tbl WHERE app_year = '$currentyear' AND app_scholar_type LIKE '%Academic%'";
