            ...
            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <form method="POST" action="php/developercoordinsert.php">
                    <div class="row mb-4">
                      <div class="col-md-12">
                                ...
                                <div class="modal fade" id="myModal' . $a_id . '" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form method="POST" action="php/developercoordupdate.php?updateid=' . $a_id . '">
                                          <div class="row mb-4">
                                            <div class="col-md-12">
    ...
    function demoSwal(a_id, a_fname, a_lname, teacher_id_number) {
      ...
      swal({
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    url: 'php/developercoorddelete-temp.php',
                    type: 'POST',
                    data: {
                        deleteid: a_id,
...
<script>
  function validatePassword2(a_id) {
    ...
    const isPasswordValid2 = checkPassword2(<?php echo $a_id ?>);
