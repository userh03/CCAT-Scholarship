        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <small><i><i class="fa fa-question-circle" aria-hidden="true"></i><span style="font-weight: 700;"> Excel Column Format:</span> Student ID Number,	Firstname,	Lastname,	Subject Code,	Subject Name,	Semester,	Year, Grade, Units</i></small>
              <form method="POST" enctype="multipart/form-data" action="php/dev-import.php">
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <small><i><i class="fa fa-question-circle" aria-hidden="true"></i><span style="font-weight: 700;"> Excel Column Format:</span> Student ID Number,	Firstname,	Lastname,	Email,	Department,	Section,	Mobile Number</i></small>
              <form method="POST" enctype="multipart/form-data" action="php/dev-import-stud.php">
                  <input class="btn btn-secondary" style="color: black;" required type="file" name="excel_file" accept=".xlsx, .xls">
                  <br><br>
                  <input class="btn btn-primary" type="submit" value="Import">
              </form>
        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <h2>Import TES Scholarship Applicants</h2>
              <form method="POST" enctype="multipart/form-data" action="php/dev-import-tes.php">
                  <input class="btn btn-secondary" style="color: black;" required type="file" name="excel_file" accept=".xlsx, .xls">
                  <br><br>
                  <input class="btn btn-primary" type="submit" value="Import">
              </form>
