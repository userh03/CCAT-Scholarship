  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
          ...
          </style>          <h1><i class="fa fa-file-text"></i> News and Updates</h1>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="myModalLabel">New Updates</h2>
                      </div>
                    <div class="modal-body">
                    <form method="POST" action="php/supercontent-insert.php" enctype="multipart/form-data">
                      <div class="row mb-4">
                        <div class="col-md-12">
                          <br><label>Title</label>
                          <input class="form-control" type="text" id="" name="title" placeholder="Enter news title" required>
                        </div>
                        <div class="col-md-12">
                          <br><label>Content</label>
                          <textarea class="form-control" type="text" id="" name="content" placeholder="Enter news content" required></textarea><br>
                        </div>
                        <div class="col-md-12">
                          <br><label>Image</label>
                            <img id="imgModal" style="max-height: 100%; width: 100%;" name="images" src="">
                            <input id="inputModal" type="file" required class="form-control inputModal" name="images">                      
                        </div>
                      </div>                      
                      </div>
                                      ...
                                      <div class="modal fade" id="myModal'.$id.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                          <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <form method="POST" action="php/supercontent.php?updateid=' . $id . '" enctype="multipart/form-data">
                                                          <div class="row mb-4">
                                                              <div class="col-md-12">
                                                          ...
                                                          <div class="row mb-4">
                                                              <div class="col-md-12">
                                                                  <br><label for="a_lname">Images:</label>
    ...
    swal({
        ...
        if (isConfirm) {
            swal({
                ...
                window.location = "php/supercontentdelete.php?deleteid=" + id;
            });
        }
    });
    }
      ...
      if (success === 'true') {
        ...
        swal({
          title: "Success!",
          text: "New Update has been added.",
          type: "success",
          showCancelButton: false,
          confirmButtonText: "OK",
          closeOnConfirm: true,
      ...
      if (update === 'true') {
        ...
        swal({
          title: "Success!",
          text: "News and Update Slide has been updated.",
          type: "success",
          showCancelButton: false,
          confirmButtonText: "OK",
          closeOnConfirm: true,
