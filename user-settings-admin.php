...
<link href="https://fonts.googleapis.com/css2?family=Oswald&display=swap" rel="stylesheet">
  ...
  <body class="app sidebar-mini">
    <!-- Navbar-->
    <header id="hNav" style="background: rgb(255, 255, 255);" class="app-header"><a href="admin-dashboard.php" id="bLogo" class="app-header__logo" style="cursor: pointer;"><img class="iMg" src="images/logo2.png"></a>
    ...
    <aside id="sNav" style="background: rgb(255, 255, 255);" class="app-sidebar">
      <div class="app-sidebar__user"><img id="uProfile" class="app-sidebar__user-avatar" src="<?php echo $profile_picture ?>" alt="">
        ...
        <p class="app-sidebar__user-name"><?php echo $sa_fname." ". $sa_lname ?></p>
        <?php
...
<script>
    function submitForm() {
        ...
        if (password === confirmPassword) {
            ...
            $.ajax({
                type: 'POST',
                url: 'php/superadminupdate-password.php?updateid=<?php echo $sa_id ?>',
                data: { 
                    password: password
                },
