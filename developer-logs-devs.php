    ...
    <main class="app-content">
      <div class="app-title">
        <div id="divProfile">
          ...
          <h1><i class="fa fa-th-list"></i> Developer Logs</h1>
          <p>List of developer logs</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="developer-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item">Logs</li>
          <li class="breadcrumb-item active"><a href="#">Developer Logs</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
            ...
            <div class="table-responsive">
              <table class="table table-hover table-bordered" id="sampleTables">
                ...
                <tbody>
                  ...
                  <?php
                  $sql = "SELECT * FROM developer_logs_tbl";
                  ...
                  while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<tr style="font-size: 15px;">
                            ...
                            <td><strong>Student ID #:</strong> ' . $superadmin_id_number . '</td>
                            <td><strong>Student Name:</strong> ' . $sa_fname . ', '. $sa_lname .'</td>
