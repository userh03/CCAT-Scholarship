  ...
  <body class="app sidebar-mini">
      ...
      <div class="tile">
        ...
        <div class="col-md-12">
            <div class="infos">
              ...
              <h4><?php echo $sa_fname." ". $sa_lname ?></h4>
              <p><?php echo $sa_building ?> - Administrator</p>
            </div>
        </div>
          <div class="col-md-12"><br>
            ...
            <form id="uploadForm" method="post" action="" enctype="multipart/form-data">
              ...
              <div class="col-md-8">
                ...
                <form method="POST" action="php/superadminupdate.php?updateid=<?php echo $sa_id ?>" style="padding-bottom: 40px;">
                  <div class="row mb-4">
                    <div class="col-md-8">
                      <br><label>Teacher ID #</label>
                      <input class="form-control" type="text" value="<?php echo $superadmin_id ?>">
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-md-4">
                      <label>First Name</label>
                      <input class="form-control" type="text" name="sa_fname" value="<?php echo $sa_fname ?>">
                    </div>
                    <div class="col-md-4">
                      <label>Last Name</label>
                      <input class="form-control" type="text" name="sa_lname" value="<?php echo $sa_lname ?>">
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-8 mb-4">
                      <br><label>Department</label>
                      <input class="form-control" type="text" name="sa_building" value="<?php echo $sa_building ?>">
                    </div>
                    <div class="col-md-8 mb-4">
                      <label>Mobile</label>
    ...
    function uploadProfilePicture() {
        ...
        setTimeout(function () {
            ...
            $.ajax({
                type: 'POST',
                url: 'php/superadmin_profile.php',
