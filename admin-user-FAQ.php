  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
          ...
          <h1><i class="fa fa-file-text"></i> Frequently Asked Questions</h1>
          <p>Edit Content on Landing Page</p>
        </div>
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="myModalLabel">New Question</h2>
                      </div>
                    <div class="modal-body">
                    <form method="POST" action="php/supercontent-insert-faq.php">
                      <div class="row mb-4">
                        <div class="col-md-12">
                          <br><label>Question</label>
                          <input class="form-control" type="text" id="" name="question" placeholder="Enter question" required>
                        </div>
                        <div class="col-md-12">
                          <br><label>Answer</label>
                          <textarea class="form-control" type="text" id="" name="answer" rows="5" placeholder="Enter answer" required></textarea><br>
                        </div>
                      </div>                      
                      </div>
                  ...
                  <tbody>
                    ...
                    <?php
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                          ...
                          echo '<tr>
                              <td style="text-align: justify; font-size: 15px;"><strong>Contents</strong>'.$answer.'</td>
                                      ...
                                      <div class="modal fade" id="myModal'.$id.'" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                          <div class="modal-dialog" role="document">
                                              <div class="modal-content">
                                                  ...
                                                  <div class="modal-body">
                                                      <form method="POST" action="php/supercontent-FAQ.php?updateid=' . $id . '" enctype="multipart/form-data">
                                                          <div class="row mb-4">
                                                              <div class="col-md-12">
                                                                  <br><label for="">Question:</label>
                                                                  <input class="form-control" name="question" rows="5" value="' . htmlspecialchars($question) . '">
                                                              </div>
                                                          </div>
                                                          <div class="row mb-4">
                                                              <div class="col-md-12">
                                                                  <br><label for="">Answer:</label>
                                                                  <textarea class="form-control" name="answer" rows="5">' . htmlspecialchars($answer) . '</textarea>
                                                              </div>
                                                          </div>
                                                          <div class="modal-footer">
                                                              <button class="btn btn-default" data-dismiss="modal">Close</button>
    ...
    swal({
        ...
        if (isConfirm) {
            swal({
                ...
                window.location = "php/supercontentdelete-FAQ.php?deleteid=" + id;
            });
        }
    });
    }
