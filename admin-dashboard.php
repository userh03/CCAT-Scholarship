      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="admin-add-edit-students.php">Registered Students</a></h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="admin-tables.php">Applicants</a></h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-star fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="admin-tables-approved.php">Approved</a></h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-ban fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="admin-tables-denied.php">Denied</a></h4>
