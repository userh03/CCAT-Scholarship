...
foreach ($targetSections_minus_1 as $section_minus_1) {
    ...
    $sql_minus_1 = "SELECT COUNT(*) as count FROM $table_minus_1 WHERE app_status = 'Denied' AND BINARY app_section LIKE ?";
...
foreach ($tables as $table) {
    foreach ($targetSections as $section) {
        ...
        $sql = "SELECT COUNT(*) as count FROM $table WHERE app_scholar_type = 'Academic Scholarship Presidential' AND BINARY app_section LIKE ?";
...
foreach ($tables2 as $table2) {
    foreach ($targetSections2 as $section2) {
        ...
        $sql2 = "SELECT COUNT(*) as count FROM $table2 WHERE app_scholar_type = 'Academic Scholarship Vice Presidential' AND BINARY app_section LIKE ?";
...
foreach ($tables3 as $table3) {
    foreach ($targetSections3 as $section3) {
        ...
        $sql3 = "SELECT COUNT(*) as count FROM $table3 WHERE app_scholar_type = 'Talent Scholarship' AND BINARY app_section LIKE ?";
...
foreach ($tables4 as $table4) {
    foreach ($targetSections4 as $section4) {
        ...
        $sql4 = "SELECT COUNT(*) as count FROM $table4 WHERE app_scholar_type = 'Service Scholarship' AND BINARY app_section LIKE ?";
...
foreach ($tables5 as $table5) {
    foreach ($targetSections5 as $section5) {
        ...
        $sql5 = "SELECT COUNT(*) as count FROM $table5 WHERE app_scholar_type = 'TES Scholarship' AND BINARY app_section LIKE ?";
...
foreach ($tables6 as $table6) {
    foreach ($targetSections6 as $section6) {
        ...
        $sql6 = "SELECT COUNT(*) as count FROM $table6 WHERE app_scholar_type = 'TWP Scholarship' AND BINARY app_section LIKE ?";
  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div class="row" id="chartss">
        ...
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">TDP Scholars</h3>
            <div class="embed-responsive embed-responsive-16by9">
