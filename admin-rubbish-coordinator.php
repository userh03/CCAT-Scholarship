  ...
  <body class="app sidebar-mini">
    ...
    <main class="app-content">
      ...
      <div id="divProfile">
          ...
          <h1><i class="fa fa-trash"></i> Restore Accounts</h1>
                    ...
                    $sql = "SELECT *
                      ...
                      while ($row = mysqli_fetch_assoc($result)){
                        ...
                        echo '<tr style="font-size: 15px;">
                                <td scope = "row"><strong>Teacher ID #: </strong>'.$teacher_id_number.'</td>
                                    <td><strong>Teacher Name: </strong>'.$a_lname.', '.$a_fname.'</td>
                                    ...
                                    <td>
                                      ...
                                      <button type="button" class="btn btn-primary" style="margin-bottom: 5px;" onclick="restore('.$a_id.')">
                                        Restore
                                      </button>
                                        <button style="margin-bottom: 5px;" class="btn btn-danger" onclick="demoSwal('.$a_id.');" name="delete">Delete</button>
                                      </div>
                                    </td>
                              </tr>';
                      }
            ...
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        window.location.href = 'php/superdelete.php?deleteid=' + a_id;
                    });
                }
            });
        };
            ...
            swal({
                ...
                if (isConfirm) {
                    swal({
                        ...
                        window.location.href = 'php/superdelete-temp-restore.php?restoreid=' + a_id;
                    });
                }
            });
        };
    ...
    <script>
        ...
        function deleteAllData() {
            ...
            var phpScriptUrl = 'php/superdelete-temp-all.php';

            // Use AJAX to send a request to the PHP script
            $.ajax({
            type: 'POST',
            url: 'php/superdelete-temp-all.php',
            ...
            success: function (response) {
                ...
                window.location.href = 'admin-rubbish-coordinator.php';
                });
            },
            error: function () {
    ...
    <script>
        ...
        function restoreAllData() {
            // Assuming you're using AJAX to call the PHP script
            // You can replace this with your actual PHP script URL
            var phpScriptUrl = 'php/superrestore-temp-all.php';

            // Use AJAX to send a request to the PHP script
            $.ajax({
            type: 'POST',
            url: 'php/superrestore-temp-all.php',
