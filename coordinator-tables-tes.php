...
<html lang="en">
  <head>
    <title>TES Applicant List</title>
  ...
  <body class="app sidebar-mini">
            ...
            @media screen and (max-width: 767px) {
                #divProfile {
                  display: none;
                    ...
                    <h1><i class="fa fa-th-list"></i> TES Applicants List</h1>
          <p>List of TES Applicants</p>
        </div>
        <ul class="app-breadcrumb breadcrumb side">
          <li class="breadcrumb-item"><a href="coordinator-dashboard.php"><i class="fa fa-home fa-lg"></i></a></li>
          <li class="breadcrumb-item active"><a href="#">TES Applicants List</a></li>
        </ul>
      </div>
      <div class="row">
        <div class="col-md-12">
    ...
    <script>
        function generateCSV() {
            window.location.href = 'php/csv_generate_denied.php';
        }

        function generateExcel() {
            window.location.href = 'php/generate_report_denied.php';
        }
    </script>
  </body>
</html>