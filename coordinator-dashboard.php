...
<link href="https://fonts.googleapis.com/css2?family=Oswald&display=swap" rel="stylesheet">
  ...
  <body class="app sidebar-mini">
    ...
    <!-- Navbar-->
    <header id="hNav" style="background: rgb(255, 255, 255); z-index: 9999;" class="app-header"><a id="bLogo" class="app-header__logo" onclick="location.reload()" style="cursor: pointer;"><img class="iMg" src="images/logo2.png"></a>
      ...
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-users fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="coordinator-add-edit-students.php">Registered Students</a></h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small warning coloured-icon"><i class="icon fa fa-files-o fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="coordinator-tables.php">Applicants</a></h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small primary coloured-icon"><i class="icon fa fa-star fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="coordinator-tables-approved.php">Approved</a></h4>
        ...
        <div class="col-md-6 col-lg-3">
          <div class="widget-small danger coloured-icon"><i class="icon fa fa-ban fa-3x"></i>
            <div class="info">
              <h4><a style="color:black !important; font-weight: 600;" href="coordinator-tables-denied.php">Denied</a></h4>
        ...
        <div class="col-md-6">
          <div class="tile">
            ...
            <h5 style="display: inline-block; margin: 0 5px;">Filter</h5>
              <select style="width: 50%;" id="demoSelect" multiple="">
